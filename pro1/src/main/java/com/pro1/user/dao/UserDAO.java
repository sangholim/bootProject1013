...
public class UserDAO extends CommonDBSession {
	...
	processHibernateSession(user, DBQueryType.INSERT);
    }
	...
	processHibernateSession(user, DBQueryType.DELETE);
    }
	...
	processHibernateSession(user, DBQueryType.UPDATE);
    }
    ...
    public CommonUserVO userUidFindUserMig(Session session, long userUid) throws Exception {
