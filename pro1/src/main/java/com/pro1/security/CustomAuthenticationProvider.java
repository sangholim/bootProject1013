...
public class CustomAuthenticationProvider implements AuthenticationProvider {
    ...
    // 1차 검증에서 먼저 인증 시도  [권한 체크 먼저 할듯]  , /login/doLogin 에서 시행하면 처음 인증을 거친후에 권한을 저장하고 ,  해당 권한으로 url 접근을 받음
    @Override
	...
	return new UsernamePasswordAuthenticationToken(id, authUser.getPw(), grantedAuthList);
    }
